...
const servicesData = [
  {
    ...
    title: "Management system (CargoSilo)",
    shortText:
      "Streamlines cargo management with advanced tracking and efficient logistics solutions.",
    viewDetails: "https://launch.enroles.com/6/login",
    aosDelay: "100",
