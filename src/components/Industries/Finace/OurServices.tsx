...
const servicesData = [
  {
    ...
    title: "Loan management system (ProperLoan)",
    shortText:
      "Streamlines loan processing and management with advanced automation and real-time tracking.",
    viewDetails: "https://properloan.enroles.com/",
    aosDelay: "100",
  ...
  },
  {
    ...
    viewDetails: "https://drive.google.com/file/d/1zMgRIPSxufFQhlORoNQYPgnGD4pQ3vUv/view",
    aosDelay: "300",
