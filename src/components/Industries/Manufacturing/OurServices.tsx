...
const servicesData = [
  {
    ...
    title: "Management system (Vyapaar)",
    shortText:
      "Streamlines your business with an all-in-one SAAS solution for stock management, POS, and invoicing.",
    viewDetails: "https://launcher.enroles.com/72/public/login",
    aosDelay: "100",
      ...
      <div className="pt-100 pb-70">
        <div className="container">
          <div className="section-title">
            <h2>Our Manufacturing & Retail Products</h2>
            {/* <p>
