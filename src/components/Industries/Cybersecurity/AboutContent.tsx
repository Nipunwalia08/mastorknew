                ...
                <div className="row justify-content-center">
                  <div className="col-lg-6 col-sm-6">
                    <div className="cs-about-card">
                      ...
                      <h4 style={{color:"#18181B"}}>Identity and Access Management (IAM)</h4>
                      <p style={{color:"#646464"}}>
                  ...
                  <div className="col-lg-6 col-sm-6">
                    <div className="cs-about-card">
                      ...
                      <h4 style={{color:"#18181B"}}>Endpoint Security</h4>
                      <p style={{color:"#646464"}}>
                ...
                <div className="row justify-content-center">
                  <div className="col-lg-6 col-sm-6">
                    <div className="cs-about-card">
                      ...
                      <h4 style={{color:"#18181B"}}>Network Security</h4>
                      <p style={{color:"#646464"}}>
                  ...
                  <div className="col-lg-6 col-sm-6">
                    <div className="cs-about-card">
                      ...
                      <h4 style={{color:"#18181B"}}>Governance, Risk, and Compliance (GRC)</h4>
                      <p style={{color:"#646464"}}>
